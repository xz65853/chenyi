...
var $this=$(this);
if($.fn.xheditor){
$("textarea.xheditor",$this).xheditor(false);}
$.ajax({
type:op.type||'GET',
url:op.url,
data:op.data,
...
if($.fn.xheditor){
$("textarea.xheditor",$p).each(function(){
var $this=$(this);
var op={html5Upload:false,skin:'nostyle',tools:$this.attr("tools")||'mfull'};
...
if(!go)return;}
if($.fn.xheditor){
$("textarea.xheditor",dialog).xheditor(false);}
